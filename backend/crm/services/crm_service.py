...
from backend.crm.repositories.employee_repository import EmployeeRepository
...
class CRMService:
    ...
    def get_employees(self, tenant_id: int) -> Dict[str, Any]:
        ...
        employees = self.employee_repo.get_all_employees(tenant_id)
        return {'success': True, 'data': employees or [], 'count': len(employees or [])}
