...
def run_renewal_email_campaign(
    ...
    """
    One cron run: eligible electricity/water contracts in 60–365 day window, one email per bucket per contract end date.
    """
    import os
    ...
    try:
        ...
        for row in rows:
            ...
            try:
                msg_id = send_resend_email(email, subject, html, txt)
