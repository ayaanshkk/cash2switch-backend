...
class Commission_Payment(Base):
    ...
    __table_args__ = (
        UniqueConstraint('contract_id', 'instalment_year', name='uq_commission_payment_contract_instalment'),
        CheckConstraint(
...
class Agent_Commission_Batch(Base):
    ...
    __table_args__ = (
        UniqueConstraint('tenant_id', 'employee_id', 'batch_month', name='uq_agent_commission_batch_tenant_employee_month'),
        CheckConstraint(
...
class Agent_Commission_Batch_Item(Base):
    ...
    __table_args__ = (
        UniqueConstraint('commission_payment_receipt_id', name='uq_agent_commission_batch_item_receipt'),
        {'schema': SCHEMA},
    )
